...
/*-------------------------- THIN FOIL ---------------------------------*/
  ...
  physicalBeTube1 = new G4PVPlacement(NULL, G4ThreeVector(0,0,    zCoating), logicalBeTube1, "BeTube1", logicalWorld, false, 0);
  physicalBeTube2 = new G4PVPlacement(NULL, G4ThreeVector(0,0, -1*zCoating), logicalBeTube2, "BeTube2", logicalWorld, false, 0);
  ...
  physicalfoil1 = new G4PVPlacement(NULL, G4ThreeVector(0,0,    zFoil), logicalfoil1, "foil1", logicalWorld, false, 0);
  physicalfoil2 = new G4PVPlacement(NULL, G4ThreeVector(0,0, -1*zFoil), logicalfoil2, "foil2", logicalWorld, false, 0);
 G4double si_dis=2.2;
...
//G4double tDead = 40.0e-9;  // Double thick dead layer
 ...
 //logicalDead1->SetUserLimits(stepLimitDead);
  ...
  G4double tSi = 0.003497; //removing the deadlayer region = 0.0035 - tdead the thickness of the silicon detector was changed from 2 mm to 3.5 mm for scinitillator as in xuan's code but the variable is still the same.
